...
import { ChevronRight, Home, Building2, Milestone, Route } from 'lucide-react';
import { AppShell } from '@/components/layout/app-shell';
import { Card, CardContent } from '@/components/ui/card';
import { PROJECT_CATALOG, type ProjectSlug } from '@/lib/content/project-catalog';
import { useDictionary } from '@/lib/i18n/dictionary-context';

const PROJECT_ICONS: Record<ProjectSlug, typeof Home> = {
  residential: Home,
    ...
    <AppShell>
      <main className="container max-w-3xl py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {PROJECT_CATALOG.map((entry) => {
            const copy = t.list[entry.slug];
            const Icon = PROJECT_ICONS[entry.slug];
            return (
